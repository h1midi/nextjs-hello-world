    ...
    <div className="w-full">
      ...
      <section className="flex flex-col items-center justify-center py-16 bg-gradient-to-r from-blue-500 to-blue-700 text-white">
        <div className="text-center max-w-2xl">
          ...
          <p className="mt-4 text-lg">{t("sub-headline")}</p>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 md:grid-cols-3">
          <div className="bg-card text-card-foreground shadow-md hover:shadow-lg transition-shadow">
            <div className="p-4">
              ...
              <p className="mt-2 text-muted-foreground">{t("offer-1-desc")}</p>
            </div>
          </div>
          <div className="bg-card text-card-foreground shadow-md hover:shadow-lg transition-shadow">
            <div className="p-4">
              ...
              <p className="mt-2 text-muted-foreground">{t("offer-2-desc")}</p>
            </div>
          </div>
          <div className="bg-card text-card-foreground shadow-md hover:shadow-lg transition-shadow">
            <div className="p-4">
              ...
              <p className="mt-2 text-muted-foreground">{t("offer-3-desc")}</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <li>
            <Accordion type="single" collapsible>
              <AccordionItem value="item-1">
                <AccordionTrigger>{t("faq-question-1")}</AccordionTrigger>
                <AccordionContent>{t("faq-answer-1")}</AccordionContent>
              </AccordionItem>
            </Accordion>
          </li>
          <li>
            <Accordion type="single" collapsible>
              <AccordionItem value="item-2">
                <AccordionTrigger>{t("faq-question-2")}</AccordionTrigger>
                <AccordionContent>{t("faq-answer-2")}</AccordionContent>
              </AccordionItem>
            </Accordion>
          </li>
          <li>
            <Accordion type="single" collapsible>
              <AccordionItem value="item-3">
                <AccordionTrigger>{t("faq-question-3")}</AccordionTrigger>
                <AccordionContent>{t("faq-answer-3")}</AccordionContent>
              </AccordionItem>
            </Accordion>
          </li>
          <li>
            <Accordion type="single" collapsible>
              <AccordionItem value="item-4">
                <AccordionTrigger>{t("faq-question-4")}</AccordionTrigger>
                <AccordionContent>{t("faq-answer-4")}</AccordionContent>
              </AccordionItem>
            </Accordion>
          </li>
        </ul>
      ...
      <footer className="p-4 bg-white shadow-md">
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-4 text-muted-foreground">
            <Link
              href="https://go.coneduc.com/facebook"
            ...
            <Link
              href="https://go.coneduc.com/instagram"
              className="hover:text-foreground"
              prefetch={false}
            >
            ...
            <Link
              href="https://go.coneduc.com/linkedin"
              className="hover:text-foreground"
              prefetch={false}
            >
            ...
            <Link
              href="https://go.coneduc.com/youtube"
              className="hover:text-foreground"
              prefetch={false}
            >
